...
const Accessibility = () => {
    return (
        <>
            ...
            <section className="mb-12">
                ...
                <div className="flash">
                    <p>
                        It's good practice to include <code>focusable="false"</code> with <code>aria-hidden</code> when
                        the element is a focusable element (ex. button, or anchor). The attribute
    ...
    <FaChevronLeft aria-hidden focusable="false" />
                    ...
                    <p>
                        ...
                        either, an <code>aria-label</code> or text within the <code>VisuallyHidden</code>, the screen
                        reader will read that the element is a button and read the button's purpose, the label.
                        Therefore the screen reader never needs to focus on the icon, which is why we set{' '}
                        <code>aria-hidden</code> to <code>true</code> and <code>focusable</code> to <code>false</code>.
                    </p>
                </div>
            </section>
            <section>
